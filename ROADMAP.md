...
### Sprint 3: 서버 기반 + 인증 시스템 (1.5주) — DONE
...
### Sprint 4: 세션 관리 + 역할 시스템 (1.5주) — DONE
...
### Sprint 5: WebSocket 실시간 통신 (1.5주) — DONE
...
### Sprint 7: 웹 클라이언트 구축 (2주) — SKIPPED (Phase 2 예정)
...
```
Sprint 1  ████████████  자막 스타일 설정     (1주)    DONE
Sprint 2  ████████████  디자인 리뉴얼        (1주)    DONE
Sprint 3  ████████████  서버 + 인증           (1.5주)  DONE
Sprint 4  ████████████  세션 관리             (1.5주)  DONE
Sprint 5  ████████████  WebSocket 실시간      (1.5주)  DONE
Sprint 6  ████████████  대기/교대 시스템      (1주)    DONE
Sprint 7  ░░░░░░░░░░░░  웹 전환              (2주)    SKIPPED
Sprint 8  ████████████  안정화/릴리스         (1주)    DONE
                                     7/8 Sprint 완료
```
...
Sprint 7(웹 클라이언트)을 포함한 향후 확장 계획은 `FUTURE_ROADMAP.md`에 별도로 정리되어 있습니다. 주요 방향:

- **웹 클라이언트 구축**: 브라우저 기반 접속, OBS 브라우저 소스 호환 (Sprint 7 범위)
- **소셜 로그인 확장**: 카카오/네이버 OAuth 연동
- **커스텀 폰트**: 사용자 폰트 업로드 및 관리
- **프로덕션 인프라**: PostgreSQL 마이그레이션, 클라우드 배포, CI/CD
- **고급 협업 기능**: 자막 자동 교정, 실시간 통계, 세션 리포트 강화
